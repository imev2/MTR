...
file = open(fold +"/data/ST3/dataset_cell_cnn_batch_noaug.dat","rb")
...
# net.trainning(num_epochs=1, file_out=fold+"/Results/ST3/CV2/1307_8_38", test_dataset=None)  


model = Model_CVRobust(imput_size, num_markers=30)
optimizer=torch.optim.Adam(model.parameters(), lr=lr)
net = Neural(train_data,val_data,model=model, loss_f=loss_f,optimizer=optimizer,device=device,sumary_lab="modelCVRobust_19_07_2000",bach_size=batch_size)                  
net.trainning(num_epochs=2000, file_out=fold+"/data/Results/ST3/CVRobust_19_07_2000.dat", test_dataset=None)  
...
# net.trainning(num_epochs=1, test_dataset=None, file_out=fold+"/Results/ST3/Linear/Linear_1206_18_10")               
...
# net.trainning(num_epochs=1, file_out=fold+"/Results/ST3/Dense/Dense_1307_8_38", test_dataset=None)  
