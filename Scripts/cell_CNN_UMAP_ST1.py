# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 10:44:43 2023
...
# ## split test/train ##
# #split test group
# data.split_data_test(fold+"/data/ST1/ST1_base_train_val", fold+"/data/ST1/ST1_base_test",perc_train = 0.9)

# # # NOT PERFORMED ## split train/val ##
# data.load(fold+"/data/ST1/ST1_base_train_val")
# data.split_data_test(fold+"/data/ST1/ST1_base_train", fold+"/data/ST1/ST1_base_val",perc_train = 0.8)
...
# train_data, val_data = data.get_dataload(fold +"/data/ST1/ST1_2D_train_dens",fold +"/data/ST1/ST1_2D_val_dens")
# data.load(fold+"/data/ST1/ST1_base")
# tam = len(data.pheno)
# pos = sum(data.pheno)
...
# class Neural:
#     def __init__(self,train_dataset,val_dataset,model,optimizer,scheduler, loss_f, device,sumary_lab=False,bach_size=16):
...
# scheduler = ReduceLROnPlateau(optimizer, "min", patience=100, min_lr=0.000001)

# model = Model_CVsimp2(imput_size, num_markers=61)
# optimizer=torch.optim.Adam(model.parameters(), lr=lr)
# net = Neural(train_data,val_data,model=model, loss_f=loss_f,optimizer=optimizer, scheduler=scheduler, device=device,sumary_lab="modelCVsimp_dense_25_07_1400",bach_size=batch_size)                  
# net.trainning(num_epochs=5000, file_out=fold+"/data/Results/ST1/modelCVsimp_dense_25_07_1400.dat", test_dataset=None)
...
# # # net.trainning(num_epochs=100, file_out=fold+"/ST1/scoresModelCVRobust_do02lr05", test_dataset=None)  
...
# # # # net.trainning(num_epochs=500, test_dataset=None, file_out=fold+"/ST1/cellCnn/scoresmodelLinear")               
...
# # # net.trainning(num_epochs=100, file_out=fold+"/ST1/scoresModelCV_dense10_do02lr05", test_dataset=None)  
