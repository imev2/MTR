...
net = Neural(train_data,val_data,model=model, loss_f=loss_f,optimizer=optimizer,device=device,sumary_lab="Model_Cell_2_ST2",bach_size=batch_size,fixed_train_size=fixed_train_size)                  
net.trainning(num_epochs=200, file_out=fold+"/data/Results/ST2/Model_Cell_2_ST2.dat", test_dataset=test_data)
