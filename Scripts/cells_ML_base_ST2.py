...
# train_path = "/data/ST2/pooled/ST2_train_val_logscale_pool"
# lab = "logscale"
# file = pd.read_csv(fold+train_path)
# file=file.iloc[:,1:]
# x= file.iloc[:, :-1]
...
# test_path = "/data/ST3/pooled/ST3_test_batch_pool_unbalanced"
...
test_path = "/data/ST2/pooled/ST2_train_scale_pool"
file = pd.read_csv(fold+test_path)
file=file.iloc[:,1:]
x_test= file.iloc[:, :-1]
y_test = file.iloc[:, -1]
...
print("RF Finished")
comb = {"y_true":y_test, "RF_y_pred":y_pred, "RF_y_prob":y_prob}
file = open(fold+"/data/ST2/pooled/logscaled_ST2_RF_test","wb")
pk.dump(comb, file)
file.close()
...
print("LR Finished")
comb = {"y_true":y_test, "LR_y_pred":y_pred, "LR_y_prob":y_prob}
file = open(fold+"/data/ST2/pooled/logscaled_ST2_LR_test.dat","wb")
pk.dump(comb, file)
file.close()

### LOG BATCH SCALED ###
# train_path = "/data/ST3/pooled/ST3_train_val_log_batch_pool"
# file = pd.read_csv(fold+train_path)
# # file = file.sample(n=20000,random_state=seed)
# file=file.iloc[:,1:]
# x_train= file.iloc[:, :-1]
...
# test_path = "/data/ST3/pooled/ST3_test_log_batch_pool_unbalanced"
# file = pd.read_csv(fold+test_path)
# file=file.iloc[:,1:]
# x_test= file.iloc[:, :-1]
# y_test = file.iloc[:, -1]
