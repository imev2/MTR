...
net = Neural(train_data=train_dataset,val_data=val_dataset,test_data=test_dataset,model=model,loss_f=loss_f,optimizer=optimizer,device=device,sumary_lab="Model_Cell_1_ST1_3107_1600_bs64_tested",bach_size=batch_size,fixed_train_size=fixed_train_size)                  
net.trainning(num_epochs=2000, file_out=fold+"/data/Results/ST1/Model_Cell_1_ST1_3107_1600_bs64.dat")