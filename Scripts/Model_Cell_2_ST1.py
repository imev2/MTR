...
# data.load(fold +"/data/ST1/ST1_train_scale_1")
# data.sample_all_cells(numcells=10000)
# ## data.augmentation(100,numcells=10000)
# data.load(fold +"/data/ST1/ST1_val_scale_1")
# data.sample_all_cells(numcells=10000)
# data.load(fold +"/data/ST1/ST1_test_scale_1")
# data.sample_all_cells(numcells=10000)
...
# train_scale_1 is the augmented training data
# val_scale_1 is unaugmented val data
# test_scale_1 is unaugmented test data
...
model = Model_Cell_2(imput_size, num_markers=28)
optimizer = optim.Adam(model.parameters(), lr=lr)

net = Neural(train_data=train_dataset,val_data=val_dataset,test_data=test_dataset,model=model,loss_f=loss_f,optimizer=optimizer,device=device,sumary_lab="Model_Cell_2_ST1_3107_1600_bs64_tested",bach_size=batch_size,fixed_train_size=fixed_train_size)                  
net.trainning(num_epochs=2000, file_out=fold+"/data/Results/ST1/Model_Cell_2_ST1_3107_1600_bs64.dat")